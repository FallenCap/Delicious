...
const AddButton = () => {
  return (
    <React.Fragment>
      <a className="relative w-24 h-12 inline-flex items-center justify-center p-4 px-6 py-3 overflow-hidden font-medium text-whie transition duration-300 ease-out border-2 border-white rounded-full shadow-md group">
